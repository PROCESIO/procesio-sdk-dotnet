...
namespace ProcesioSDK
{
    ...
    public interface IProcesioClient
    {
        ...
        /// <exception cref="ProcessPublishException">This exception is thrown if the Process publish operation has failed</exception>
        /// <exception cref="ProcessFileUploadException">This exception is thrown if the Input file upload operation has failed for either of the input files</exception>
        Task<Response<LaunchResponse>> RunProcess(string processId, Dictionary<string, object> inputValues, ProcesioApiKey procesioApiKey, string workspace = null, List<FileContent> inputFiles = null);
        ...
        /// <exception cref="ProcessPublishException">This exception is thrown if the Process publish operation has failed</exception>
        /// <exception cref="ProcessFileUploadException">This exception is thrown if the Input file upload operation has failed for either of the input files</exception>
        Task<Response<ProcessStatusResponse>> RunProcess(string processId, Dictionary<string, object> inputValues, ProcesioApiKey procesioApiKey, string workspace = null, List<FileContent> inputFiles = null, int timeOut = 60);
        ...
        /// <param name="workspace">The workspace name. Can be null if working on the personal workspace.</param>
        /// <returns>The process status response</returns>
        Task<Response<ProcessStatusResponse>> GetProcessStatus(string processInstanceId, ProcesioApiKey procesioApiKey, string workspace = null);
